...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-anntbma.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-anntbma.containers.anotherwebservice.com/
...
```
git clone git@github.com:ThangNguyen157/container-anntbma.git
cd container-anntbma
```
...
```
docker attach container-anntbma
```
